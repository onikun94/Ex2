...
public class StateFactory extends Factory<Integer, State> {
	...
	public StateFactory() {
		...
		makeItem(Integer.valueOf(SC_FF0), new ReadFromOpe0());
		makeItem(Integer.valueOf(SC_FF1), new ReadFromOpe1());
		makeItem(Integer.valueOf(SC_FF2), new ReadFromOpe2());
		makeItem(Integer.valueOf(SC_TF0), new ReadToOpe0());
		makeItem(Integer.valueOf(SC_TF1), new ReadToOpe1());
